 ...
 * @author Mike Brock
 */
public class UIDataFieldInitProblemsInspection extends BaseJavaLocalInspectionTool {
  @NotNull
  @Override
  public String getDisplayName() {
    return "Show potential initialization problems with @DataField elements in a templated bean";
  }
  ...
  public String getShortName() {
    return "DataFieldInitialization";
  }
