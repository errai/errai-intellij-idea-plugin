...
//  private static final Key<TextRange> referenceMarker = Key.create("RENAME_REF_MARKER");
    ...
    registrar.registerReferenceProvider(new AnnotationMatchingPattern(Types.BOUND),
        new PsiReferenceProvider() {
          ...
          public PsiReference[] getReferencesByElement(@NotNull PsiElement element, @NotNull ProcessingContext context) {
            ...
            final String text = ((String) literalExpression.getValue()).replace(Util.INTELLIJ_MAGIC_STRING, "");

            final DataBindUtil.TemplateBindingMetaData metaData = DataBindUtil.getTemplateBindingMetaData(element);
